...
<script>
	...
	<div data-component-categoryitem="{parentWrapper:.item-list-wrap, imgWrapper:.item-imgwrap}">
		...
		<div class="item-info">
			...
			<a href="/kr/ko_kr/t/adult-unisex/fw/action-outdoor/BV1310-001/mimj83/nike-sb-dunk-low-pro-og-qs"><span class="item-title">나이키 SB 덩크 로우 프로 OG</span></a>
...
<script>
	...
	<!-- </th:block> -->
		...
		<div class="btn-pagination more" data-module-pagination="{type:scroll,totalCount:672,currentPage:1,pageSize:40,target:.item-list-wrap,api:/kr/ko_kr/w/men/fw,scrollWrapper:window,scrollContainer:document,lineSize:5}"></div>
