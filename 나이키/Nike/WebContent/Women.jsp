...
<meta id="f_site_name" name="f_site_name" property="og:site_name" content="나이키" />
		...
		<meta id="f_title" name="f_title" property="og:title" content="women - 나이키" />
	

	
	
		<meta name="description" content="women - 나이키" />
		<meta id="f_description" name="f_description" property="og:description" content="women - 나이키" />
			...
			<ul class="uk-float-right header-mymenu">
				<li>
					<span>
						...
						<a data-component-loginmodal="" title="로그인" data-click-area="Upper GNB" data-click-name="login" class="login">로그인</a>
					</span>
	...
	<section class="wrapper">
		...
		<section class="pt_main">
									...
									<div class="content-container">
														...
														<div><!-- 내용 이미지경로 https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/ -->
<div class="category_WLP">
	<div class="sec01">
		<div class="txtArea">
			<p class="tit">
				<img alt="나이키우먼" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/160930_WLP_p1_title.png" /></p>
			<ul class="menuW">
				<li>
					<a href="/kr/ko_kr/w/women/fw" data-click-area="glp" data-click-name="lnav_women_shoes"><img alt="신발" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/160930_wlp_p1_menu1.png" /></a></li>
				<li>
					<a href="/kr/ko_kr/w/women/ap" data-click-area="glp" data-click-name="lnav_women_clothing"><img alt="의류" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/160930_wlp_p1_menu2.png" /></a></li>
				<li>
					<a href="/kr/ko_kr/w/women/xb/xc/f/new" data-click-area="glp" data-click-name="lnav_women_new releases"><img alt="신상품" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/161026_wlp_p1_menu3.png" /></a></li>
				<li>
					<a href="/kr/ko_kr/c/women/f/best" data-click-area="glp" data-click-name="lnav_women_bestseller"><img alt="베스트셀러" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/161026_wlp_p1_menu4.png" /></a></li>
				<li>
					<a href="/kr/ko_kr/w/women/xb/now-trending" data-click-area="glp" data-click-name="lnav_women_now trending"><img alt="최신트렌드" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/161026_wlp_p1_menu5.png" /></a></li>
			</ul>
		</div>
	</div>	
	<div class="secP1">
		<div class="imgArea">
			<img alt="bg" class="bg" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/181115_wlp_p1_bg.jpg">
		</div>
		<div style="padding : 40px 0 60px; text-align: center;">
			<p class="tit">
				<img alt="겨울을 위한 스타일: 테크팩 파카" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/181115_wlp_p1_tit_1.png" /></p>
			<p class="tail white">
				<img alt="바람과 비로부터 몸을 보호해줄 기능성 원단, 그리고 재킷이나 두꺼운 상의 위에도 매치할 수 있는 넉넉한 핏의 테크팩 파카를 만나보세요." src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/181115_wlp_p1_tail_1.png" /></p>
			<div class="btnArea" style="text-align: center; margin: 20px 0;">
				<a class="def_btn_black" style="padding: 0 20px;" href="/kr/ko_kr/w/women/xb/xc/utility-collection"data-click-area="glp" data-click-name="women_p1_1_button_181116_utility collection_shop now">구매하기</a>
			</div>
		</div>
	</div>	
	<div class="secP1">
		<div class="imgArea">
			<img alt="bg" class="bg" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/181107_wlp_p1_bg.jpg">
			<div class="vodArea">
				<video muted="" preload="true" loop="" autoplay=""><source src="https://nikevideo.nike.com/72451143001/201810/224/72451143001_5847705971001_5847708434001.mp4" type="video/mp4" />
				</video>
			</div>
		</div>
		<div style="padding : 40px 0 60px; text-align: center;">
			<p class="tit">
				<img alt="강인함의 완성, 메탈릭 디테일" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/181107_wlp_p1_tit.png" /></p>
			<p class="tail white">
				<img alt="새로워진 메탈릭 클래시 컬렉션으로 언제 어디서나 강인하고 스타일리시하게." src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/181107_wlp_p1_tail.png" /></p>
			<div class="btnArea" style="text-align: center; margin: 20px 0;">
				<a class="def_btn_black" style="padding: 0 20px;" href="/kr/ko_kr/w/women/xb/xc/metallic-clash"data-click-area="glp" data-click-name="women_p2_1_button_181116_metallic clash_shop now">구매하기</a>
			</div>
		</div>
	</div>	
	<div class="secP1">
		<div class="imgArea">
			<img alt="bg" class="bg" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/181101_wlp_p1_bg2.jpg">
		</div>
		<div style="padding : 40px 0 60px; text-align: center;">
			<p class="tit">
				<img alt="에어 포스 1 '07 로우" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/181101_wlp_p1_tit3.png" /></p>
			<p class="tail white">
				<img alt="36년이 지나도 변하지 않는 클래식 아이콘. " src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/181101_wlp_p1_tail_2.png" /></p>
			<div class="btnArea" style="text-align: center; margin: 20px 0;">
				<a class="def_btn_black" style="padding: 0 20px;" href="/kr/ko_kr/w/women/xb/xc/air-force-1-07-collection" data-click-area="glp" data-click-name="women_p3_1_button_181116_af1 white low_shop now">구매하기</a>
			</div>
		</div>
	</div>	
	<div class="secP1">
		<div class="imgArea">
			<img alt="bg" class="bg" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/181018_wlp_p1_bg.jpg">
			<div class="vodArea">
				<video muted="" preload="true" loop="" autoplay=""><source src="https://nikevideo.nike.com/72451143001/201810/3999/72451143001_5850201580001_5850195674001.mp4" type="video/mp4" />
				</video>
			</div>
		</div>
		<div style="padding : 40px 0 60px; text-align: center;">
			<p class="tit">
				<img alt="BATTLE FORCE" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/181018_wlp_p1_tit.png" /></p>
			<p class="tail">
				<img alt="농구와 스트릿 컬쳐의 만남. 아트, 랩, 댄스, 그리고 농구가 함께 하는 ‘배틀포스’에서 여러분만의 포스를 보여주세요." src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/1810118_nsw_p1_tail-2.png" /></p>
			<div class="btnArea" style="text-align: center; margin: 20px 0;">
				<a class="def_btn_black" href="/kr/ko_kr/w/women/xb/xc/battle-force-collection"data-click-area="glp" data-click-name="women_p4_1_button_181116_battle force_shop the collection">컬렉션 구매하기</a>
				<div class="btn" style="text-align: center; display: inline-block;">
					<div class="btn_drop" style="margin-left: 10px;">
						<button class="def_btn_black" type="button" style="padding:0 25px;">배틀포스 참가하기 <b> ＞</b></button>
						<div class="btn_menu white" style="display: none; border-top:1px solid #c8c8c8;">
							<a class="over01" href="/kr/ko_kr/c/nsw/battleforce"data-click-area="glp" data-click-name="women_p4_2_button_181116_battle force_learn more">자세히 보기</a>
							<a class="over01" href="/kr/ko_kr/c/nsw/battleforce/art"data-click-area="glp" data-click-name="women_p4_3_button_181116_battle force_join art battle">ART BATTLE 참가하기</a>
							<a class="over01" href="/kr/ko_kr/c/nsw/battleforce/rap"data-click-area="glp" data-click-name="women_p4_4_button_181116_battle force_join rap battle">RAP BATTLE 참가하기</a>
							<a class="over01" href="/kr/ko_kr/c/nsw/battleforce/dance"data-click-area="glp" data-click-name="women_p4_5_button_181116_battle force_join dance battle">DANCE BATTLE 참가하기</a>
							<a class="over02" href="/kr/ko_kr/c/nsw/battleforce/hoops"data-click-area="glp" data-click-name="women_p4_6_button_181116_battle force_join hoops battle">HOOPS BATTLE 참가하기</a>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="secP1">
		<div class="imgArea">
			<img alt="bg" class="bg" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/181004_hp_p3_bg1.jpg">
			<div class="vodArea">
				<video muted="" preload="true" loop="" autoplay=""><source src="https://nikevideo.nike.com/72451143001/201810/3647/72451143001_5843029522001_5843023186001.mp4" type="video/mp4">
				</video>
			</div>
		</div>
		<div style="padding : 40px 0 60px; text-align: center;">
			<p class="tit">
				<img alt="AF FRIDAY" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/181004_hp_p3_bg2.jpg"></p>
			<p class="tail">
				<img alt="매주 새롭게 공개되는 최고의 에어 포스 1을 만나보세요." src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/181004_wlp_p3_tail_1.png"></p>
			<div class="btnArea" style="text-align: center; margin: 20px 0;">
				<a class="def_btn_black" style="padding: 0 20px;" href="/kr/ko_kr/w/xg/fw/force-friday-collection" data-click-area="glp" data-click-name="women_p5_1_button_181116_af friday_shop now">구매하기</a>
			</div>
		</div>
	</div>	
	<div class="sec02" style="margin-bottom: 20px;">
		<img alt="bg" class="bg" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/181102_wlp_p5_bg.jpg" />
		<div class="txtArea3" style="margin-top: -63.5px;left:0;">
			<p class="tit">
				<img alt="나를 위한 완벽한 브라" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/181102_wlp_p5_tit.png" /></p>
			<p class="tail white">
				<img alt="나이키 클래식 스파클 브라" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/181102_wlp_p5_tail.png" /></p>
			<p class="btn">
				<a class="def_btn_white" style="padding: 0px 20px;" href="/kr/ko_kr/t/women/ap/women-training/AA4246-010/fwnv39/as-nike-classic-sparkle-bra"data-click-area="glp" data-click-name="women_p6_1_button_181116_classic sparkle bra_shop now">구매하기</a>
				<a class="def_btn_white" href="/kr/ko_kr/w/women/ap/xc/sports-bras" data-click-area="glp" data-click-name="women_p6_2_button_181116_indy logo bra_shop all bra" style="margin-left: 10px;">브라 전체보기</a>
	...
	<div class="sec04_1" style="margin-top: 4%; margin-bottom: 3.5%;">
		<div class="subArea">
			<p class="subTxt">
				<img alt="시즌 트렌드" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/180306_wlp_p3_tit.png"></p>
		</div>
		<div class="imgArea">
			<img alt="bg" class="bg" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/181102_wlp_p6_bg1.jpg">
			<ul class="linkArea">
				<li><a href="/kr/ko_kr/t/women/fw/nike-sportswear/AV4618-200/nfzh53/wmns-classic-cortez-leather"data-click-area="glp" data-click-name="women_p7_1_img_181116_season trend_wmns-classic-cortez-leather_shop now"></a></li>
				<li><a href="/kr/ko_kr/t/women/fw/nike-sportswear/BQ2728-200/xjnx04/w-nike-react-element-55"data-click-area="glp" data-click-name="women_p7_2_img_181116_season trend_w-nike-react-element-55_shop now"></a></li>
				<li><a href="/kr/ko_kr/t/women/fw/nike-sportswear/AO3108-202/clif47/w-nike-m2k-tekno"data-click-area="glp" data-click-name="women_p7_3_img_181116_season trend_w-nike-m2k-tekno_shop now"></a></li>
				<li><a href="/kr/ko_kr/t/women/fw/running/AJ4115-646/ncgd52/w-nike-zoom-pegasus-35-turbo"data-click-area="glp" data-click-name="women_p7_4_img_181116_season trend_w-nike-zoom-pegasus-35-turbo_shop now"></a></li>
			</ul>
		</div>
		<ul class="txtArea">
			<li>
				<p class="tit">나이키 클래식 코르테즈 레더</p>
				<p class="tail">우먼스 라이프스타일 신발</p></li>
			<li>
			...
			<li style="margin-right: 0;">
				...
				<p class="tail">우먼스 러닝 신발</p></li>
				<div style="clear: both;"></div>
		</ul>
	</div>	
	<div class="sec04" style="border-bottom: #dedede 1px solid;padding-bottom: 5%;">
		<div class="subArea">
			<p class="subTxt">
				<img alt="구매하기" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/160930_WLP_p4_tit.png" /></p>
		</div>
		<div class="imgArea">
			<img alt="bg" class="bg" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/181107_wlp_p5_bg_1.jpg" />
			<ul style="width: 93.9%;left: 3%;">
				<li>
					<a href="/kr/ko_kr/w/women/ap/xc/sports-bras"data-click-area="glp" data-click-name="women_p8_1_img_181116_shop now_sports bras"><span><img src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/180921_wlp_p5_menu1.png" alt="스포츠 브라" /></span></a></li>
				<li style="width: 32.5%; margin: 0px 1.33%">
					<a href="/kr/ko_kr/w/women/ap/pants-tights"data-click-area="glp" data-click-name="women_p8_2_img_181116_shop now_pants & tights"><span><img src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/180921_wlp_p5_menu2.png" alt="팬츠 & 타이츠" /></span></a></li>
				<li style="width: 32.33%">
					<a href="/kr/ko_kr/w/women/xb/xc/fall-selects-collection"data-click-area="glp" data-click-name="women_p8_3_img_181116_shop now_fall selects"><span><img src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/181107_wlp_p5_menu3.png" alt="가을 아이템" /></span></a></li>
			</ul>
		</div>
	</div>
<!-- Content END -->
<!-- MerchMenu CORNER START -->
			...
			<div class="section menu1">
				<div class="area">
					<div class="box">
						...
						<ul class="list">
							<li>
								<a href="/kr/ko_kr/w/women/fw" data-click-area="glp" data-click-name="mnav_women shoes_all shoes">전체보기</a></li>
							<li>
								<a href="/kr/ko_kr/w/women/fw/lifestyle" data-click-area="glp" data-click-name="mnav_women shoes_lifestyle">라이프스타일</a></li>
							<li>
								<a href="/kr/ko_kr/w/women/fw/running" data-click-area="glp" data-click-name="mnav_women shoes_running">러닝</a></li>
							<li>
								<a href="/kr/ko_kr/w/women/fw/gym-training" data-click-area="glp" data-click-name="mnav_women shoes_training">트레이닝 & 짐</a></li>
							<li>
								<a href="/kr/ko_kr/w/women/fw/golf" data-click-area="glp" data-click-name="mnav_women shoes_golf">골프</a></li>
							<li>
								<a href="/kr/ko_kr/w/women/fw/tennis" data-click-area="glp" data-click-name="mnav_women shoes_tennis">테니스</a></li>
						</ul>
					</div>
					<div class="btn">
						<a class="btn-set btn-add" href="#" title="내용 더보기">더보기</a></div>
					<div class="bar">
						 </div>
				</div>
			</div>
			<div class="section menu2">
				<div class="area">
					<div class="box">
						...
						<ul class="list">
							<li>
								<a href="/kr/ko_kr/w/women/ap" data-click-area="glp" data-click-name="mnav_women clothing_all clothing">전체보기</a></li>
							<li>
								<a href="/kr/ko_kr/w/women/ap/hoodies-crews" data-click-area="glp" data-click-name="mnav_women clothing_hoodies">후디 & 크루</a></li>
							<li>
								<a href="/kr/ko_kr/w/women/ap/xc/sports-bras" data-click-area="glp" data-click-name="mnav_women clothing_sport bras">스포츠 브라</a></li>
							<li>
								<a href="/kr/ko_kr/w/women/ap/pants-tights" data-click-area="glp" data-click-name="mnav_women clothing_pants & tights">팬츠 & 타이츠</a></li>
							<li>
								<a href="/kr/ko_kr/w/women/ap/tops-tshirts" data-click-area="glp" data-click-name="mnav_women clothing_top & t-shirts">탑 & 티셔츠</a></li>
							<li>
								<a href="/kr/ko_kr/w/women/ap/jackets-vests" data-click-area="glp" data-click-name="mnav_women clothing_jackets& vests">아우터웨어</a></li>
							<li>
								<a href="/kr/ko_kr/w/women/ap/nike-pro-compression" data-click-area="glp" data-click-name="mnav_women clothing_nike pro">나이키프로</a></li>
							<li>
								<a href="/kr/ko_kr/w/women/ap/shorts" data-click-area="glp" data-click-name="mnav_women clothing_short pants">숏팬츠</a></li>
							<li>
								<a href="/kr/ko_kr/w/women/ap/skirts-dresses" data-click-area="glp" data-click-name="mnav_women clothing_skirts & dresses">스커트 & 드레스</a></li>
						</ul>
					</div>
					<div class="btn">
						<a class="btn-set btn-add" href="#" title="내용 더보기">더보기</a></div>
			...
			<div class="section menu3">
				<div class="area">
					<div class="box">
						...
						<ul class="list">
							<li>
								<a href="/kr/ko_kr/w/women/eq/accessories-equipment" data-click-area="glp" data-click-name="mnav_women gear_all gear">전체보기</a></li>
							<li>
								<a href="/kr/ko_kr/w/women/eq/hats-visors-headbands" data-click-area="glp" data-click-name="mnav_women gear_hats & headbands">모자 & 헤드밴드</a></li>
							<li>
								<a href="/kr/ko_kr/w/women/eq/bags" data-click-area="glp" data-click-name="mnav_women gear_bags">가방</a></li>
							<li>
								<a href="/kr/ko_kr/w/women/eq/socks" data-click-area="glp" data-click-name="mnav_women gear_socks">양말</a></li>
							<li>
								<a href="/kr/ko_kr/w/women/eq/gym-training" data-click-area="glp" data-click-name="mnav_women gear_training accessories">트레이닝 액세서리</a></li>
							<li>
								<a href="/kr/ko_kr/w/women/eq/gloves" data-click-area="glp" data-click-name="mnav_women gear_gloves">장갑</a></li>
						</ul>
					</div>
					<div class="btn">
						<a class="btn-set btn-add" href="#" title="내용 더보기">더보기</a></div>
			...
			<div class="section menu4">
				<div class="area">
					<div class="box">
						...
						<ul class="list">
							<li>
								<a href="/kr/ko_kr/w/women/ap/pants-tights" data-click-area="glp" data-click-name="mnav_women collection_pants & tights guide">팬츠 & 타이츠 가이드</a></li>
							<li>
								<a href="/kr/ko_kr/w/women/ap/xc/sports-bras" data-click-area="glp" data-click-name="mnav_women collection_bra fit guide">브라 가이드</a></li>
							<li>
								<a href="/kr/ko_kr/w/women/xb/xc/f/clearance" data-click-area="glp" data-click-name="mnav_women collection_clearance">가격인하</a></li>
						</ul>
					</div>
					<div class="btn">
						<a class="btn-set btn-add" href="#" title="내용 더보기">더보기</a></div>
	...
	<style type="text/css">
	.Merch{max-width:900px; background:none;}
	.Merch div.content{width:900px}
	.Merch div.content .section{width:205px}
	.Merch div.content .section .area .bar{width:200px}
	.Merch div.content .section .area .box ul.list li{font-size:13px}	</style>
<!-- MerchMenu CORNER END -->	
	<div class="sec06">
		<div class="imgArea">
			<img alt="bg" class="bg" src="https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/180913_wlp_p6_bg_1.jpg" />
			<ul>
				<li>
					<div class="txtArea">
						<p class="tit">
							NIKE+ TRAINING CLUB APP</p>
						<p class="tail">
							항상 함께하는 나만의 트레이너</p>
						<p class="btn">
							<a href="/kr/ko_kr/c/nike-plus/training-app" data-click-area="glp" data-click-name="women_p9_1_text_181116_get moving_ntc learn more">자세히 보기</a></p>
					</div>
				</li>
				<li style="margin-right: 0;">
					<div class="txtArea">
						<p class="tit">
							NIKE+ RUN CLUB APP</p>
						<p class="tail">
							나에게 최적화된 맞춤형 코칭 플랜과 함께 달리세요.</p>
						<p class="btn">
                           <a href="/kr/ko_kr/c/running/nike-run-club" data-click-area="glp" data-click-name="women_p9_2_text_181116_get moving_nrc learn more">자세히 보기</a></p>
					</div>
				</li>
			</ul>
		</div>
	</div>
<!--동영상레이어-->	<div class="videoWrap">
...
<style type="text/css">
	.fallow-con { display: none;}
	.category_WLP *{font-family:'NanumGothic', '나눔고딕', Malgun Gothic, '맑은고딕', Apple Gothic, Dotum, '돋움', sans-serif;}
	.category_WLP .bg {width: 100%;}
	.category_WLP > div {position: relative; width: 100%; font-family:'NanumGothic', '나눔고딕', Malgun Gothic, '맑은고딕', Apple Gothic, Dotum, '돋움', sans-serif !important;}
	
	.sec01 { position: relative;}
	.sec01 .txtArea { padding: 4.5% 0 3.5%; text-align: center;}
	.sec01 .txtArea .tit { margin-bottom:2.5%;}
	.sec01 .txtArea .menuW {}
	.sec01 .txtArea .menuW:after { display: block; clear: both; content: "";}
	.sec01 .txtArea .menuW li { display: inline-block; padding-left: 3px; background: url(https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/160804_bb_slp_p1_menu_line.png) no-repeat; line-height: 30px; background-position: 0 8px;}
	.sec01 .txtArea .menuW li:first-child { background: none;}
	.sec01 .txtArea .menuW li a { display: block; margin:  5px 50px; height: 20px; line-height: 20px; }

	.secP1 { position: relative;}
	.secP1 .vodWrap { position: absolute; top:0; left:0%; width:100%; display: block;}
	.secP1 .vodWrap video { width: 100%; height: 100%;}
	.secP1 .tit {text-align:center; font-size: 1.8em; letter-spacing: -1px; font-weight: 600; margin-bottom: 15px;}
	.secP1 .tail {text-align:center; font-size: 1.1em; letter-spacing: 0px; font-weight: 400; margin-bottom: 20px;}
	.secP1 .imgArea {position: relative;overflow:hidden;}
	.secP1 .imgArea .imgLink {position: absolute;top:0;left:0;width:100%;height:100%;}
	.secP1 .imgArea .imgLink a{display:block;width:100%;height:100%;text-indent:-9999em;}
	.secP1 .vodArea { position: absolute; top:0%; left:0%; width:100%; height: auto; display: block;}
	.secP1 .vodArea video { width: 100%; height: 100%;}
	
	.vodArea1 { position: absolute; top: 0%; left: 0%; width: 100%; height: 100%; overflow: hidden; display:none;}
	.vodArea1 video { width: 100%; height: auto;}
	.backImg { display: none;}
	.posterImg { display: block;}
    
	.sec02 { position: relative; overflow:hidden;}
	.sec02 .imgArea{ position: relative;}
	.sec02 .txtArea0 {position: absolute; top: 50%; text-align: center !important; z-index: 10;}
	.sec02 .txtArea {position: absolute; left:2.9%; top: 7.9%; text-align: left !important; z-index: 10;}
	.sec02 .txtArea1 {position: absolute; right:2.9%; top: 7.9%; text-align: right !important; z-index: 10;}
	.sec02 .txtArea3 {position: absolute; right: 0; top: 50%; text-align: center; z-index: 10;width:50%; margin-top:-45px;}
    .sec02 .subtxt { position: absolute;bottom:6%;right:50px;}
    .sec02 .sName { position: absolute; bottom: 5%; right: 50px;}
    .sec02 .txtArea2 { position: absolute; top:50%; left: 0px; width: 100%; text-align: center;margin-top:-25px;z-index: 10;}
    .sec02 .tit { font-size: 1.8em; letter-spacing: -1px; font-weight: 600; margin-bottom: 15px;}
    .sec02 .tail { font-size: 1.1em; letter-spacing: 0px; font-weight: 400; margin-bottom: 20px;}
    .sec02 .btn a { display: inline-block; vertical-align: middle;}
	.sec02 .vodArea { position: absolute; top:0%; left:0%; width:100%; height: auto; display: block;}
	.sec02 .vodArea video { width: 100%; height: auto;}

	.sec03_2 { position: relative; margin: 0 0 6%;}
	.sec03_2 .subArea { width: 100%; height: 80px; line-height: 80px;}
	.sec03_2 .subArea:after { display: block; clear: both; content: "";}
	.sec03_2 .subArea .subTxt {font-size:1.8em; font-weight:600; float: left; margin-left: 3.5%;}
	.sec03_2 ul.txtArea {width:94%; margin:0 auto;}
	.sec03_2 ul.txtArea:after { display: block; clear: both; content: "";}
	.sec03_2 ul.txtArea li { float: left; width:24%; margin-right:1.33%; text-align: left;}
	.sec03_2 ul.txtArea li .tit { font-size: 1.1em; font-weight: 600; line-height: 1.2em; margin-bottom: 10px; color:#000;}
	.sec03_2 ul.txtArea li .tail { font-size: 1em; font-weight: 400; line-height: 1.4em; margin-bottom: 25px; color:#555;}
	.sec03_2 a{color:#000; font-weight:600;}
	.sec03_2 a:hover, .sec03_2 a:focus{border-bottom:1px solid #000;}
	
	.sec03_1 { position: relative;}
	.sec03_1 p{text-align:center;}
	.sec03_1 .tit_tit {margin-top:0%;margin-bottom:20px;margin-left:3.5%;text-align:left;}
	.sec03_1 .txtArea{width:94%; margin:0 auto;}
	.sec03_1 .txtArea li{width:50%; float:left;}
	
	.sec03 { position: relative; margin-top:3.5%;}
	.sec03 .subArea { width: 100%; height: 80px; line-height: 80px;}
	.sec03 .subArea:after { display: block; clear: both; content: "";}
	.sec03 .subArea .subTxt { float: left; margin-left: 3.5%;}
	.sec03 .imgArea { position: relative;overflow:hidden;}
	.sec03 .imgArea ul { position: absolute; top: 0; left: 3%; width:95%; height: 100%;}
	.sec03 .imgArea ul:after { display: block; clear: both; content: "";}
	.sec03 .imgArea ul li { float:left; width: 48.8%; height: 100%; margin: 0 0.5%;}
	.sec03 .imgArea ul li a { display: block; width: 100%; height: 100%; text-indent: -9999em;}
	.sec03 .imgArea .vodArea2 {position: absolute; top:-28%; left:0; width: 100%; height: auto;}
	.sec03 .imgArea .vodArea2 video { width: 100%; height: 100%;}

	.sec03 ul.txtArea { width: 93%; margin:2.5% auto 4%;}
	.sec03 ul.txtArea:after { display: block; clear: both; content: "";}
	.sec03 ul.txtArea li { float: left; width: 50%; text-align: left;}
	.sec03 ul.txtArea li .tit { font-size: 1.8em; font-weight: 600; line-height: 1.2em; margin-bottom:10px;color:#000;}
	.sec03 ul.txtArea li .tail { font-size: 1.1em; font-weight: 400; line-height: 1.3em; margin-bottom:20px;color:#000;}
	.sec03 ul.txtArea li a{color:#000; font-weight:600;}
	.sec03 ul.txtArea li a:hover, .sec03 ul.txtArea li a:focus{border-bottom:1px solid #000;}
	.cta{position: absolute;top: 50%;left: 50%;padding: 0px 20px !important;margin-left: -42px;text-indent:0; border-radius:0 !important;margin-top: -20px;}
	
	.sec04 { position: relative; padding-bottom: 2.5%;}
	.sec04 .subArea { width: 100%; height: 80px; line-height: 80px;}
	.sec04 .subArea:after { display: block; clear: both; content: "";}
	.sec04 .subArea .subTxt { float: left; margin-left: 3.5%;}
	.sec04 .imgArea { position: relative;}
	.sec04 .imgArea ul { position: absolute; top: 0; left: 6%; width:90%; height: 100%;}
	.sec04 .imgArea ul:after { display: block; clear: both; content: "";}
	.sec04 .imgArea ul li { float: left; width: 32.5%; height: 100%;}
	.sec04 .imgArea ul li a { display: block; width: 100%; height: 100%; position: relative;}
	.sec04 .imgArea ul li a span { position: absolute; top: 50%; width: 100%; margin-top: -14px; text-align: center; color: #fff; font-size: 1.5em; font-weight: 600;}
	.sec04 .imgArea ul.linkArea li { float: left; width: 33%; height: 100%;}
	.sec04 .imgArea ul.linkArea li a { display: block; width: 100%; height: 100%; position: relative;}
	.sec04 .txtArea:after{display:block; clear:both; content:"";}
	.sec04 .txtArea {position:relative; width:93.5%; margin:0 auto; margin-top:0.8%; text-align:center;}
	.sec04 .txtArea li{float:left; width: 32%; margin-left: 1.3%; text-align:center;}
	.sec04 .txtArea li:last-child{margin-right: 0%;}
	.sec04 .txtArea li .tit{color:#000;font-size:1.38em; font-weight:600;margin-bottom:10px;}
	.sec04 .txtArea li .tail{color:#000;font-size:1.1em;margin-bottom:20px;}
	.sec04 .border_btm{font-weight: 500;}
	.sec04 .border_btm:hover, .sec04 .border_btm:focus{border-bottom:1px solid #000;}

	.sec04_1 .subArea {width: 100%;height: 80px;line-height: 80px;}
	.sec04_1 .subArea .subTxt {float: left;margin-left: 3.5%;}
	.sec04_1 .imgArea {position: relative;}	
	.sec04_1 .imgArea ul {position: absolute;top: 0;left: 3%;width: 94%;height: 100%;}
	.sec04_1 .imgArea ul.linkArea li {float: left;width: 25%;height: 100%;}	
    .sec04_1 .txtArea {position: relative;width: 93.5%;margin: 0 auto;margin-top: 1.5%;text-align: center; display: block;}
	.sec04_1 .txtArea li {float: left;width: 24%;margin-right: 1.33%;text-align: left;}	
	.sec04_1 .txtArea li .tit {color: #000;font-size: 1.38em;font-weight: 600;margin-bottom: 10px;}
	.sec04_1 .txtArea li .tail {color: #666666;font-size: 1.1em;margin-bottom: 20px;}	
	.sec04_1 .imgArea ul.linkArea li a {display: block;width: 100%;height: 100%;position: relative;}	

	.sec05 { position: relative;}
	.sec05 .txtArea { width: 93%; margin:6% auto 4%;}
    .sec05 .txtArea .tit { font-size: 1.8em; letter-spacing: -1px; font-weight: 600; margin-bottom: 15px;}
    .sec05 .txtArea .tail { font-size: 1.1em; letter-spacing: 0px; font-weight: 400; margin-bottom: 19px; color:#666;}
	.sec05 a{color:#000; font-weight:600;}
	.sec05 a:hover, .sec05 a:focus{border-bottom:1px solid #000;}
	.sec05 .imgArea { position:relative;}
	.sec05 .imgArea .link_area{position:absolute;top:5%;left:3%;width:96%;height:80%;}
	.sec05 .imgArea .link_area:after{display:block;clear:both;content:"";}
	.sec05 .imgArea .link_area li{ float:left;width:25%;height:100%;}
	.sec05 .imgArea .link_area li a{ display:block;position:relative;width:100%;height:100%;}
	.sec05 .imgArea .link_area li a span{ display:none;position: absolute;top:40%;left:50%;margin-left:-40px;}
	.sec05 .imgArea .txt_area{position:absolute;top:0;left:7%;width:86%;text-align:left;}
	.sec05 .imgArea .txt_area:after{display:block;clear:both;content:"";}
	.sec05 .imgArea .txt_area li{ float:left;width:32%;margin-right:2%; height:100%;}
	.sec05 .imgArea .txt_area li p{margin-left:4%;}
	.sec05 .imgArea .txt_area li .tit{margin-top: 7%; font-size:1.2em;font-weight:600;}
	.sec05 .imgArea .txt_area li .tail{margin-top:2%; margin-bottom: 4%; font-size:1.1em; color:#666;}
			
	.sec06 { position: relative; margin-bottom: 50px;}
	.sec06 .subArea { width: 100%; height: 80px; line-height: 80px;}
	.sec06 .subArea:after { display: block; clear: both; content: "";}
	.sec06 .subArea .subTxt { float: left; margin-left: 3.5%;}
	.sec06 .imgArea { position: relative;}
	.sec06 .imgArea ul { position: absolute; top: 0; left: 1.3%; width:97.4%; height: 100%;}
	.sec06 .imgArea ul:after { display: block; clear: both; content: "";}
	.sec06 .imgArea ul li { float: left; width: 49.4%; height: 100%; margin-right: 1.2%; position: relative;}
	.sec06 .imgArea ul li .txtArea { position: relative; top: 55%; left: 0; width: 100%; text-align: center;}
	.sec06 .imgArea ul li .txtArea .tit { font-size: 2em; font-weight: 600; line-height: 1.2em; color: #fff; margin-bottom: 10px;letter-spacing:0px;}
	.sec06 .imgArea ul li .txtArea .tail { font-size: 1.05em; font-weight: 400; line-height: 1.25em; color: #fff; margin-bottom: 13px;}
	.sec06 .imgArea ul li .txtArea .btn a { font-size: 1.05em; font-weight: 500; line-height: 1.25em; color: #fff;}
	.sec06 .imgArea ul li .txtArea .btn a:hover { text-decoration: underline;}
			
	.borN { border:0px none;}

	/* 동영상레이어 */
	.videoWrap{position:fixed !important; top:0; left:0; width:100%; height:100%; z-index:1000; display: none;}
	.videoWrap .video_file{position:absolute; width:907px; height:510px;  z-index:12; background: #000;}
	.videoWrap .video_file iframe {width: 100%;height: 100%; padding:0; border:0;}
	.videoWrap .btn_close_video{display:block; position:absolute; right:-42px; top:0px; width:42px; height:42px; background:url('https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/btn-overlay-close_m_150417.png') no-repeat 0 0; z-index:12;}
	.video_overlay {position:fixed; width:100%; height:100%; background-color:#fff; filter: alpha(opacity=85); opacity:0.85; z-index:10; display:none;}

	/* 버튼 */
	.def_btn_line {display: inline-block; font-size: 1.1em; font-weight: 500; text-align: center; color: #000;border-bottom: 1px solid #fff;}
	.def_btn_line:hover, .def_btn_line:focus{ border-bottom: 1px solid #000;}
	.def_btn_alpha {display: inline-block;*display: inline;*zoom: 1;padding: 0 15px;height: 40px;line-height: 40px;font-size: 1.1em;font-weight: 500;background: #fff;vertical-align: middle;text-align: center;color: #000;border:1px solid #c8c8c8;}
	.def_btn_white{display:inline-block; *display:inline; *zoom:1; padding:0 15px; height:40px; line-height:40px; font-size:1.1em; font-weight:500; background:#fff; vertical-align:middle; text-align:center; color:#000;border-radius: 3px; letter-spacing:-0.5px !important;}
	.def_btn_black{display:inline-block; *display:inline; *zoom:1; padding:0 15px; height:40px; line-height:40px; font-size:1.1em; font-weight:500; background:#000; vertical-align:middle; text-align:center; color:#fff;border-radius: 3px;letter-spacing:-0.5px !important;}
	.def_btn_black:focus, .def_btn_black:hover{color:#fff !important;}
	.def_btn_gray{display:inline-block; *display:inline; *zoom:1; padding:0 15px; height:40px; line-height:40px; font-size:1.1em; border-radius: 3px; font-weight:500; background:#e1e1e1; vertical-align:middle; text-align:center; color:#000;letter-spacing:-0.5px !important;}
	.def_btn_white.pad20, .def_btn_black.pad20, .def_btn_gray.pad20{padding:0 20px;}
	.def_btn_white.rad3, .def_btn_black.rad3, .def_btn_gray.rad3{border-radius: 3px;}

	/* dropdown button */
	.btn_drop{position:relative; display:inline-block; *display:inline; *zoom:1; height:40px}
	.btn_drop.on{height:auto}
	.btn_drop button{cursor:pointer}
	.btn_drop .btn_menu{position:absolute; left:0; top:38px; width:100%; overflow:hidden; border-radius:0 0 3px 3px; display:none;}
	.btn_drop .btn_menu.white{background:#fff}
	.btn_drop .btn_menu.black{background:#000}
	.btn_drop .btn_menu.gray{background:#e1e1e1}
	.btn_drop .btn_menu a{width:100%; height:40px; line-height:40px; display:block; text-align:center; font-size:1.1em; font-weight:500 !important; border-bottom:1px solid #f2f2f2; font-family:"NanumGothic","나눔고딕",sans-serif}
	.btn_drop .btn_menu.gray{background:#e1e1e1}
	.btn_drop .btn_menu.gray a{width:100%; color:#000; height:40px; line-height:40px; display:block; text-align:center; font-size:1.1em; font-weight:500 !important; border-bottom:1px solid #d1d1d1}
	.btn_drop .btn_menu.black a{width:100%; color:#fff; height:40px; line-height:40px; display:block; text-align:center; font-size:1.1em; font-weight:500 !important; border-bottom:1px solid #333}
	a.over02 { border-top:1px solid #f2f2f2; }

	.category-max-width { margin: auto; }
	.section-category.item-list-lesspage-segment-category { width: inherit !important; float: inherit !important; }
	...
	/* 시스템폰트 */
	.category_WLP div{font-size:13px}
	@media (max-width:1200px) {.category_WLP div {font-size:12px}}
	@media (max-width:1100px) {.category_WLP div {font-size:11px}}
	@media (max-width:1000px) {
		.category_WLP div {font-size:11px}
	}
	@media (max-width:900px) {	
	.tit_03_1{width:172.8px;}
	.tail_03_1{width:206.4px;}
	.tit_03_2{width:136.8px;}
	.tail_03_2{width:260px;}
	}</style>
<script>
	$(document).ready(function(){
		$(".cta").hide();		
		$(".sec05 .imgArea .link_area li a").mouseenter(function(){
			$(this).children("span").stop().fadeIn(300);	
		});		
		$(".sec05 .imgArea .link_area li a").mouseleave(function(){
	...
	$(function(){
		// 팝업 영상
		var openVod = false;
		$(".btn_vod").on('click', function(){
			$(".videoWrap").show();
			$(".video_overlay").show();
			var tx = ($(window).width()-$(".videoWrap .video_file").width())/2;
			var ty = ($(window).height()-$(".videoWrap .video_file").height())/2;
			$(".video_file").html('<iframe src="https://players.brightcove.net/72451143001/ba4419ad-fa74-4610-8ec1-f9a32f335d91_default/index.html?videoId=5745700326001&autoplay" allowfullscreen webkitallowfullscreen mozallowfullscreen></iframe><a class="btn_close_video" href="#" title="닫기"> </a>');
			$(".video_file").css({left:tx+"px", top:ty+"px"});
			openVod = true;
			$("a.btn_close_video").on('click', function(){
				$(".videoWrap, .video_overlay").hide();		
				$(".video_file").html('');	
				return false;
			});
			return false;
...
/*****************************
    버튼 스타일
*****************************/
.btn-set {display:inline-block; background:url(https://static-breeze.nike.co.kr/kr/ko_kr/cmsstatic/structured-content/2357/btn.png) no-repeat; vertical-align:middle;}
.btn-set.btn-add {background-position:-376px 0; width: 35px; height:20px; text-indent:-10000px;}
.btn-set.btn-recent-left {background-position:0px -123px; width:8px; height:11px;}
.btn-set.btn-recent-left:hover, .btn-set.btn-recent-left:focus, .btn-set.btn-recent-left:active {background-position:0px -134px; width:8px; height:11px;}
.btn-set.btn-recent-right {background-position:-8px -123px; width:8px; height:11px;}
.btn-set.btn-recent-right:hover, .btn-set.btn-recent-right:focus, .btn-set.btn-recent-right:active {background-position:-8px -134px; width:8px; height:11px;}

/*** Merch Menu ***/
.Merch {position:relative; width:100%;  height:300px; margin:auto; z-index:10;}
.Merch div.content {position:relative; width:960px; margin:auto; top:60px; height:180px;}
.Merch div.content .section {float:left; position:relative; width:220px; height:180px; margin-left:10px; padding-left:10px;  border-left:1px solid #eee;  }
.Merch div.content .section:first-child {margin:0; border:none;}
.Merch div.content .section.menu1 {z-index:4;}
.Merch div.content .section.menu2 {z-index:3;}
.Merch div.content .section.menu3 {z-index:2;}
.Merch div.content .section.menu4 {z-index:1;}
.Merch div.content .section .area {position:relative;}
.Merch div.content .section .area .box {position:relative;  height:115px; margin-bottom:50px; overflow:hidden; padding:0 10px;}
.Merch div.content .section .area .box div.title {font-size:1.4em; height:16px; padding-bottom:15px; line-height:16px; font-weight:bold;}
.Merch div.content .section .area .box ul.list li {display:block; height:21px; line-height:21px; font-size:1em;}
.Merch div.content .section .area .box ul.list li a:hover {color:#fa5400;}
.Merch div.content .section .area .bar {position:relative; left:0; bottom:0; width:220px;  border-bottom:10px solid #eee;}
.Merch div.content .section .area .btn {position:absolute; left:50%; top:73%; margin-left:-17px; margin-bottom:20px;}
.Merch div.content .section .area .btn a {text-indent: -10000px;}
.Merch div.content .section.active .area {position:absolute; top:-21px; left:-11px; padding:20px 30px 20px 20px;  background-color:#fff; border:1px solid #eee; z-index:100;  -webkit-box-shadow: 0 0 2px 1px #ccc; -moz-box-shadow:0 0 2px 1px #ccc; box-shadow:0 0 2px 1px #ccc;}
.Merch div.content .section.active .area .box { margin-bottom:0px;}
.Merch div.content .section.active .area .btn {display:none;}
.Merch div.content .section.active .area .bar {border-bottom:10px solid #000;}
.Merch{max-width:900px; background:none; /* border-top:1px solid #dedede; */ height: 250px;}
.Merch div.content{width:900px}
.Merch div.content .section{width:205px}
.Merch div.content .section .area .bar{width:200px}
.Merch div.content .section .area .box ul.list li{font-size:13px}
</style>
<script type="text/javascript">
	/*** Merch***/
	$(function() {
	...
	<div class="uk-offcanvas-bar uk-offcanvas-bar-flip">
		<div class="user-state" id="layout-mobile-menu-user">
			...
			<a data-click-area="Upper GNB" data-click-name="login" href="/kr/ko_kr/login?successUrl=/l/women"> 로그인</a>
